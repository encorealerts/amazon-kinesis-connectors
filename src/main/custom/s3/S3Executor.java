...
public class S3Executor extends KinesisConnectorExecutor<String, byte[]> {
    private static final String CONFIG_FILE = "S3.properties";
    ...
    public KinesisConnectorRecordProcessorFactory<String, byte[]>
        ...
        return new KinesisConnectorRecordProcessorFactory<String, byte[]>(new S3Pipeline(), this.config);
    }
    ...
    public static void main(String[] args) {
        KinesisConnectorExecutor<String, byte[]> s3Executor = new S3Executor(CONFIG_FILE);
        s3Executor.run();
    }
}
